...
public class TrainerSignupUI extends JFrame {
	...
	public TrainerSignupUI() {
		...
		JLabel lblNewLabel = new JLabel("教練註冊");
		...
		username.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) {
				...
				Trainer t1 = new TrainerServiceImpl().queryByUsername(uiUsername);
				if (t1 == null) {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (t1 == null) {
					...
					Trainer t2 = new Trainer(uiName,uiUsername,uiPassword,uiEmail);
					new TrainerServiceImpl().addTrainer(t2);
