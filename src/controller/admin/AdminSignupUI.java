...
public class AdminSignupUI extends JFrame {
	...
	public AdminSignupUI() {
		...
		JLabel lblNewLabel = new JLabel("管理員註冊");
		...
		username.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) {
				...
				Admin a1 = new AdminServiceImpl().queryByUsername(uiUsername);
				if (a1 == null) {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (a1 == null) {
					...
					Admin a2 = new Admin(uiName,uiUsername,uiPassword,uiEmail);
					new AdminServiceImpl().addAdmin(a2);
